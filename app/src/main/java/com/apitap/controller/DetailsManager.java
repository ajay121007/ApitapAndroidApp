        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for (int z = 0; z < mainArray.length(); z++) {
                    ...
                    if (jobj.has("_101")) {
                        if (jobj.getString("_101").equals("010100008")) {
                            ...
                            for (int i = 0; i < imgeArray.length(); i++) {
                                ...
                                detailsBean.setSellerName(sellerName);
                            ...
                            for (int i = 0; i < imgeArray.length(); i++) {
                                ...
                                String option_name = jsonObject2.getString("_122_134");
                        ...
                        } else if (jobj.getString("_101").equals("010100008")) {
                            Log.d("sss", s);
                        }
                    }
                }
