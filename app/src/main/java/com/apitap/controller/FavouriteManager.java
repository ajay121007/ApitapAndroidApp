        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for (int z = 0; z < mainArray.length(); z++) {
                    ...
                    if (jobj.has("_101")) {
                        if (jobj.getString("_101").equals("010400221")) {
                            ...
                            if (idItemorSpecial.equals("23")) {
                                for (int i = 0; i < imgeTrsult.length(); i++) {
                                    ...
                                    for (int j = 0; j < jsonArray2.length(); j++) {
                                        ...
                                        favdetailsbean.setBusiness_type(business_type);
                                ...
                                if (favBeanSpecial.get44().equals("Transaction Approved")) {
