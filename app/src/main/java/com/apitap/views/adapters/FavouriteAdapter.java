...
import com.apitap.views.customviews.ImageViews;
import com.apitap.views.fragments.FragmentAllItems;
...
public class FavouriteAdapter extends RecyclerView.Adapter<FavouriteAdapter.ViewHolder> implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    public FavouriteAdapter(Activity activity, HashMap<Integer, ArrayList<Favdetailsbean>> map, List<FavBeanOld.RESULT> list,String selected_Sort) {
        this.map = map;
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if (list.get(position).get12083().contains(selected_Sort)) {
    ...
    public class Baseadap extends  RecyclerView.Adapter<ViewHolders> {
        ...
        public void onBindViewHolder(ViewHolders holder, final int position) {
         /*   if (allImages.get(position).get11498().equals(allImages.get(position).get122158()) || allImages.get(position).get122158().equals("") || allImages.get(position).get122158().equals("0") || allImages.get(position).get122158().equals("0.00")) {
            ...
            Picasso.with(activity).load(ATPreferences.readString(activity, Constants.KEY_IMAGE_URL) + allImages.get(position).get121170()).into(holder.imageView);
