...
public class FragmentShoppingAsst extends Fragment implements View.OnClickListener {
    ...
    TextView searchFav, searchNearBy, searchAllStores;
    ...
    private void initViews(View v) {
        ...
        searchFav = (TextView) v.findViewById(R.id.search_favorites);
        add_cat = (ImageView) v.findViewById(R.id.add_category);
        add_subcat = (ImageView) v.findViewById(R.id.sub_category);
        searchNearBy = (TextView) v.findViewById(R.id.search_nearby);
        searchAllStores = (TextView) v.findViewById(R.id.search_all_stores);
        circularProgressView = (CircularProgressView) v.findViewById(R.id.pocket);
    ...
    private void setListener(View v) {
        ...
        v.findViewById(R.id.search_favorites).setOnClickListener(this);
        v.findViewById(R.id.search_nearby).setOnClickListener(this);
        v.findViewById(R.id.search_all_stores).setOnClickListener(this);
    ...
    private void setListenerOnList() {
        mList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                tv_itemName.setText(selectedItem);
                v = view;
                position = i;
