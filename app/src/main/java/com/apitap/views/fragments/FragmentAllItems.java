...
public class FragmentAllItems extends Fragment implements View.OnClickListener{
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            description.setText(/*Utils.hexToASCII*/(array.get(position).getCategoryName()));
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String actualPrice =array.get(position).getActualPrice();
                    String priceAfterDiscount =array.get(position).getPriceAfterDiscount();
