...
public class FragmentDrawer extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        images = new Integer[]{R.drawable.home,R.drawable.ic_icon_store_white,
                R.drawable.ads, R.drawable.special, R.drawable.item, R.drawable.scan_slider, R.drawable.cart_slider, R.drawable.email_slider
                , R.drawable.shop, R.drawable.favourite, R.drawable.history, R.drawable.settings, R.drawable.logout};
