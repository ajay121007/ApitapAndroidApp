...
public class MerchantDetailActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener,
    ...
    private void initViews() {
        ...
        ModelManager.getInstance().getMerchantManager().getMerchantDetail(this,
                Operations.makeJsonGetMerchantDetail(this, "0001202A000000000858"), Constants.GET_MERCHANT_SUCCESS);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
           ...
           case R.id.tv_view_store:
               startActivity(new Intent(this,AllStoresActivity.class));
                break;
        }
    }
