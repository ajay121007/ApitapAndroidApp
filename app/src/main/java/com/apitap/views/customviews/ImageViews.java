...
/**
 * Created by Shami on 30/10/2017.
 */
...
public class ImageViews extends android.support.v7.widget.AppCompatImageView {
    ...
    public ImageViews(Context context, AttributeSet attrs, int defStyle) {
        ...
        Field f;
        try {
            f = ImageView.class.getDeclaredField("mAdjustViewBounds");
            f.setAccessible(true);
            setAdjustViewBounds((Boolean) f.get(this));

            f = ImageView.class.getDeclaredField("mMaxWidth");
            f.setAccessible(true);
            setMaxWidth((Integer) f.get(this));

            f = ImageView.class.getDeclaredField("mMaxHeight");
            f.setAccessible(true);
            setMaxHeight((Integer) f.get(this));
        } catch (Exception e) {
            Log.e("Access to failed", e+"");
        }
    }
